...
if ( !class_exists( "contentProtectorPlugin" ) ) {
    ...
    define( "CONTENT_PROTECTOR_VERSION", "2.6" );
    ...
    class contentProtectorPlugin
    {
        ...
        function addHeaderCode()
        {
            ...
            if ( !is_admin() ) { ?>
                ...
                <style type="text/css">
                    ...
                    <?php } ?> <?php if ( false !== get_option( CONTENT_PROTECTOR_HANDLE . '_border_color' ) ) { ?> border-color: <?php echo get_option( CONTENT_PROTECTOR_HANDLE . '_border_color' ); ?>;
                    ...
                    <?php } ?> <?php if ( false !== get_option( CONTENT_PROTECTOR_HANDLE . '_background_color' ) ) { ?> background-color: <?php echo get_option( CONTENT_PROTECTOR_HANDLE . '_background_color' ); ?>;
                    <?php } ?>
                    }

                    input.content-protector-form-submit {
                    <?php if ( false !== get_option( CONTENT_PROTECTOR_HANDLE . '_form_submit_label_color' ) ) { ?> color: <?php echo get_option( CONTENT_PROTECTOR_HANDLE . '_form_submit_label_color' ); ?>;
                    <?php } ?> <?php if ( false !== get_option( CONTENT_PROTECTOR_HANDLE . '_form_submit_button_color' ) ) { ?> background-color: <?php echo get_option( CONTENT_PROTECTOR_HANDLE . '_form_submit_button_color' ); ?>;
                    <?php } ?>
                    }

                    div.content-protector-correct-password {
                    <?php if ( false !== get_option( CONTENT_PROTECTOR_HANDLE . '_success_message_color' ) ) { ?> color: <?php echo get_option( CONTENT_PROTECTOR_HANDLE . '_success_message_color' ); ?>;
                    ...
                    <?php if ( false !== get_option( CONTENT_PROTECTOR_HANDLE . '_error_message_color' ) ) { ?> color: <?php echo get_option( CONTENT_PROTECTOR_HANDLE . '_error_message_color' ); ?>;
                    ...
                    <?php if ( false !== get_option( CONTENT_PROTECTOR_HANDLE . '_ajax_loading_message_font_weight' ) ) { ?> font-weight: <?php echo get_option( CONTENT_PROTECTOR_HANDLE . '_ajax_loading_message_font_weight' ); ?>;
                    <?php } ?> <?php if ( false !== get_option( CONTENT_PROTECTOR_HANDLE . '_ajax_loading_message_font_style' ) ) { ?> font-style: <?php echo get_option( CONTENT_PROTECTOR_HANDLE . '_ajax_loading_message_font_style' ); ?>;
                    <?php } ?> <?php if ( false !== get_option( CONTENT_PROTECTOR_HANDLE . '_ajax_loading_message_color' ) ) { ?> color: <?php echo get_option( CONTENT_PROTECTOR_HANDLE . '_ajax_loading_message_color' ); ?>;
                    <?php } ?>
                    }

                    label.content-protector-form-instructions {
                    <?php if ( false !== get_option( CONTENT_PROTECTOR_HANDLE . '_form_instructions_color' ) ) { ?> color: <?php echo get_option( CONTENT_PROTECTOR_HANDLE . '_form_instructions_color' ); ?>;
        ...
        function __captchaWidthFieldCallback()
        {
            ...
            echo '<input type="text" class="regular-text" name="' . CONTENT_PROTECTOR_HANDLE . '_captcha_width' . '" id="' . CONTENT_PROTECTOR_HANDLE . '_captcha_width' . '" value="' . $current_value . '" />';
        ...
        function __captchaHeightFieldCallback()
        {
            ...
            echo '<input type="text" class="regular-text" name="' . CONTENT_PROTECTOR_HANDLE . '_captcha_height' . '" id="' . CONTENT_PROTECTOR_HANDLE . '_captcha_height' . '" value="' . $current_value . '" />';
        ...
        function __captchaFieldLengthFieldCallback()
        {
            ...
            echo '<input type="text" name="' . CONTENT_PROTECTOR_HANDLE . '_captcha_field_length' . '" id="' . CONTENT_PROTECTOR_HANDLE . '_captcha_field_length' . '" value="' . $current_value . '" size="2" maxlength="2" />';
            echo "<p>" . __( "Set the character length for the HTML password/text element when you use a CAPTCHA for your forms.", "content-protector" ) . "</p>";
        }
